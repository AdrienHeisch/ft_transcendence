...
- [x] _Major_ Use a framework for both the frontend and backend
- [x] _Major_ Implement real-time features using WebSockets or similar technology
- [x] _Major_ Allow users to interact with other users
